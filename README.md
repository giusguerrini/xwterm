...
You can find a more detailed explanation here: [Basic example](./doc/10-basic-page.md).
...
A detailed description of channels is here: [Communication drivers](./doc/40-communication-drivers.md)
...
A detailed description of the server is here: [Sample server](./doc/90-sample-server.md).
...
[Coding conventions](./doc/60-coding-conventions.md)
